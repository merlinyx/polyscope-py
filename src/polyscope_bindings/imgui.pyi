...
def Image(user_texture_id, size: ImVec2, uv0: ImVec2, uv1: ImVec2, tint_col: ImVec4, border_col: ImVec4) -> None: ...
def ImageButton(user_texture_id, size: ImVec2, uv0: ImVec2, uv1: ImVec2, frame_padding: int, bg_col: ImVec4, tint_col: ImVec4) -> bool: ...
